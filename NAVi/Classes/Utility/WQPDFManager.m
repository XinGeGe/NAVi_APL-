...

{
    ...
    NSString *myfilePath=[baseCachesPath stringByAppendingPathComponent:@"ImageToPDF"];
    if (![[NSFileManager defaultManager] fileExistsAtPath:myfilePath]) {
        [[NSFileManager defaultManager] createDirectoryAtPath:myfilePath
                                  withIntermediateDirectories:YES
                                                   attributes:nil
                                                        error:NULL];
        
    }
    return [myfilePath stringByAppendingPathComponent:filename];
}
