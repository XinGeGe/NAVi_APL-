...
// 图片保存成功提示文字
#define XLPhotoBrowserSaveImageSuccessText @" Save succeed ";
// 图片保存失败提示文字
#define XLPhotoBrowserSaveImageFailText @" Save failed ";
// 网络图片加载失败的提示文字
#define XLPhotoBrowserLoadNetworkImageFail @"msgLoadFailed"
#define XLPhotoBrowserLoadingImageText @"msgLoading"

// browser背景颜色
#define XLPhotoBrowserBackgrounColor [UIColor colorWithRed:118.0/255.0 green:118.0/255.0 blue:118.0/255.0 alpha:1]
// browser 图片间的margin
