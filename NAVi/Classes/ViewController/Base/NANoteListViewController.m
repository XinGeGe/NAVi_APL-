...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NADoc *doc = [_pageArray objectAtIndex:_myselectIndex];
    [self setDairy:doc];
...
//        NSString *str = [NSString stringWithFormat:@"%d面",i + 1];
    ...
    self.nowIndex = _pageArray.count - _myselectIndex - 1;
...
- (void)toSearchViewController
{
    ...
    search.haveChangeIndex = self.nowIndex;
    search.isfromWhere = @"NOTE";
...
-(void)toHomeViewController{
    ...
    home.dayNumber = 0;
    home.regionDic = _regionDic;
    home.haveChangeIndex = self.nowIndex;
...
- (void)toGripViewController
{
    ...
    grip.clipNumber = 1;
    grip.haveChangeIndex = self.nowIndex;
    grip.isfromWhere = @"NOTE";
