...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    mybounds.size.width=[Util screenSize].width;
    mybounds.size.height=[Util screenSize].height;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (hud.superview == nil)
	{
		if (interaction == NO)
		{
			...
			background = [[UIView alloc] initWithFrame:_mywindow.bounds];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    screen.size.width=[Util screenSize].width;
    screen.size.height=[Util screenSize].height;
//    NSLog(@"[Util screenSize]=%f",[Util screenSize].width);
//    NSLog(@"[Util screenSize]height=%f",[Util screenSize].height);
	...
	if (background != nil) background.frame = screen;
}
