...
//#define HUD_WINDOW_COLOR		[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.8]
#define HUD_WINDOW_COLOR        [UIColor blackColor]
...
@property (nonatomic, retain) AGWindowView *mywindow;
