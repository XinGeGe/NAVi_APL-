...
#import "NANoteCell.h"
#import "FontUtil.h"
@interface NANoteCell ()

@end

@implementation NANoteCell
...
- (void)updateViews
{
    ...
    switch (self.cellType) {
        case NAiPadLandscape:
            ...
            detailFrame = CGRectMake(originX, originY -5, frameWidth, frameHeight);
        ...
        case NAiPhoneLandscape:
            ...
            frameHeight = 70.0f;
            lineFrame = CGRectMake(originX, originY + 1, frameWidth, 1);
            detailFrame = CGRectMake(originX, originY + 10, frameWidth, frameHeight);
            //originY = originY + frameHeight;
            break;
